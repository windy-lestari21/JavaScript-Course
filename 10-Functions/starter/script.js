...
const checkIn = function (flightNum, passenger) {
  ...
  if (passenger.passport === 123456780) {
    alert('Check in');
  } else {
...
lufthansa.book(239, 'Win');
lufthansa.book(789, 'John Behemdik');
...
book.call(lufthansa, 234, 'Merry Cooper');
...
book.call(swiss, 564, 'Marine Cooper');
console.log(swiss);
