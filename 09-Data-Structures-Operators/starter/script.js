...
console.log(maskCreditCard(433365552665564));
console.log(maskCreditCard(455433333333555444));
console.log(maskCreditCard('554454452705646464'));
...
// EXample
const staff = ['waiter', 'chef', 'manager', 'chef', 'waiter', 'chef'];
const staffUnique = [...new Set(staff)];
console.log(staffUnique);
console.log(
  new Set(['Witer', 'Chef', 'Waiter', 'Manager', 'Chef', 'Waiter']).size
);
console.log(new Set('jonasschemetman').size);
...
// console.log(users[0]?.game ?? 'User array empty');
...
// // Use ANY data type, return ANY data
// console.log('----OR----');
// console.log(3 || 'Jonas');
// console.log('' || 'Jonas');
// console.log(true || 0);
